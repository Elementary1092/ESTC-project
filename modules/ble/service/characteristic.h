...
typedef enum
{
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_BROADCAST = 1 << 0,
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_READ = 1 << 1,
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_WRITE_WITHOUT_RESPONSE = 1 << 2,
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_WRITE = 1 << 3,
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_NOTIFICATION = 1 << 4,
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_INDICATION = 1 << 5,
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_AUTHENTICATED_WRITE = 1 << 6,
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_EXTENDED_PROPERTIES = 1 << 7,
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_RELIABLE_WRITE = 1 << 8,
	ESTC_BLE_SERVICE_CHARACTERISTIC_ALLOW_WRITABLE_AUXILARIES = 1 << 9
} estc_ble_service_characteristic_allowed_ops_t;

typedef enum
{
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_UINT8,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_UINT16,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_UINT32,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_UINT64,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_INT8,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_INT16,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_INT32,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_INT64,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_FLOAT32,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_FLOAT64,
	ESTC_BLE_SERVICE_CHARACTERISTIC_TYPE_STRING,
...
} estc_ble_service_characteristic_config_t;

typedef struct
{
	estc_ble_service_t value_handle;
	estc_ble_service_t user_description_handle;
	estc_ble_service_t client_characteristic_descriptor_handle;
	estc_ble_service_t server_characteristic_descriptor_handle;
} estc_ble_characteristic_handles_t;
